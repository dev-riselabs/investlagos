...
const ReadyToInnovate = () => {
  return (
    <section className="bg-green100 px-6 py-20">
      <div className="mx-auto flex max-w-3xl flex-col items-center text-center font-jost">
        {/* Heading */}
        ...
        {/* Subtitle */}
        <p className="mb-8 max-w-120 text-[15px] leading-relaxed text-white/80 sm:text-base">
          Join thousands of young entrepreneurs shaping Lagos's future through
