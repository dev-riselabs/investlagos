...
const KeyPriorities = () => {
  const priorities = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M8 29.3333V5.33329C8 4.62605 8.28095 3.94777 8.78105 3.44767C9.28115 2.94758 9.95942 2.66663 10.6667 2.66663H21.3333C22.0406 2.66663 22.7189 2.94758 23.219 3.44767C23.719 3.94777 24 4.62605 24 5.33329V29.3333H8Z"
            stroke="#F9A04D"
          ...
          />
          <path
            d="M7.99935 16H5.33268C4.62544 16 3.94716 16.281 3.44706 16.781C2.94697 17.2811 2.66602 17.9594 2.66602 18.6667V26.6667C2.66602 27.3739 2.94697 28.0522 3.44706 28.5523C3.94716 29.0524 4.62544 29.3333 5.33268 29.3333H7.99935"
            stroke="#F9A04D"
            stroke-width="2.66667"
            stroke-linecap="round"
            stroke-linejoin="round"
  ...
  return (
    <section className="bg-[#F6F9F8] px-4 md:px-10 lg:px-20 py-20 lg:py-24">
      <div className="mx-auto max-w-310 font-jost">
        {/* Section Heading */}
        <h2 className="mb-14 text-center text-3xl font-bold text-black300 sm:text-4xl">
          Key Priorities
        </h2>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {priorities.map((item, index) => (
            ...
            >
              ...
              {/* Title & Description */}
              <h3 className="mb-3 text-[17px] font-bold text-black300">
                {item.title}
              </h3>
              <p className="text-[14px] leading-relaxed text-black300/70">
                {item.description}
              </p>
            </div>
          ))}
