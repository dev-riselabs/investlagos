...
const locMembers = [
  {
    ...
    bio: [
      ...
      'Folashade holds a BA Hons in Accounting Finance, an MBA from the Open University Business School, and has completed advanced leadership programs at Lagos Business School, Said Business School, University of Oxford and Harvard Kennedy School. Recognised as one of Nigeria\'s top 30 inspiring women, she has also represented Nigeria as a Senator at the World Business Angels Investment Forum, advocating for financial inclusion and gender parity.',
    ],
  },
  {
    name: 'Mr. Sam Egube',
    ...
    <article className="flex flex-col il-card">
      ...
      <div className="mt-6 flex flex-1 flex-col">
        ...
        <div className="mt-4 space-y-3">
          {bio.map((paragraph, i) => (
            <p key={i} className="text-[13px] leading-relaxed text-slate-500">
              {paragraph}
            </p>
          ))}
        </div>
    ...
    <section className="bg-white px-6 py-16 lg:py-24">
      <div className="mx-auto max-w-[1240px]">
        ...
        <div className="mb-12 text-center">
          <h2 className="text-xl font-black text-green200 sm:text-2xl lg:text-[28px]">
            Local Organising Committee (LOC)
          </h2>
          <p className="mt-2 text-sm text-slate-400">Committee Members</p>
        </div>
