...
function WinnerSection() {
  return (
    <section className="px-4 md:px-10 lg:px-20 py-15 md:py-20 bg-white">
        <div className="flex flex-col gap-6 md:flex-row md:items-center bg-green100 rounded-4xl p-6 md:p-10">
            ...
            <div className="md:basis-1/2 border-4 border-white h-120 rounded-2xl px-10 w-full">
