...
const PressSection = () => {
  return (
    <section className="bg-white  md:px-10 lg:px-20 py-20 lg:py-28">
      <div className="flex flex-col gap-6 px-4 md:flex-row max-w-310 mx-auto">
        <div className="flex flex-col justify-center gap-4 md:flex-1">
          ...
          <p className="leading-7 text-green400 font-jost text-lg">
            The summit, scheduled for June 8–10, 2026, will bring together
            global investors, policymakers, and industry leaders to explore
            structured opportunities across priority sectors including
            technology, infrastructure, manufacturing, and the creative economy.
          </p>
