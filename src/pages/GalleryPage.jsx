    ...
    <>
      ...
      <div className="flex h-20 bg-black100 divide-x divide-white/30">
        <button
          ...
          className={`flex items-center justify-center flex-1 text-2xl! font-bold! font-jost! text-white ${activeTab === 2 ? "bg-green100" : "bg-transparent hover:bg-green150"}`}
        >
          Invest Lagos 2.0
        </button>
        <button
          onClick={() => handleTabChange(3)}
          className={`flex items-center justify-center flex-1 text-2xl! font-bold! font-jost! text-white ${activeTab === 3 ? "bg-green100" : "bg-transparent hover:bg-green350"}`}
        >
          Invest Lagos 3.0
        </button>
      </div>
